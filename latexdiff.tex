...
\author{
\alignauthor
\DIFdelbegin \DIFdel{Mukesh Saini}\DIFdelend \DIFaddbegin \DIFadd{Vineel Kumar Raj}\DIFaddend \\
       \affaddr{Dept. of Computer Science}\\
       \DIFdelbegin %DIFDELCMD < \affaddr{National University of Singapore}%%%
\DIFdelend \DIFaddbegin \affaddr{Indian Institute Of Technology Ropar}\DIFaddend \\
       \DIFdelbegin %DIFDELCMD < \email{mksaini@comp.nus.edu.sg}
%DIFDELCMD < %%%
\DIFdelend \DIFaddbegin \email{2016csb1062@iitrpr.ac.in}
\DIFaddend \alignauthor \DIFdelbegin \DIFdel{Raghudeep Gadde }\DIFdelend \DIFaddbegin \DIFadd{Jagadeesh Chavali }\DIFaddend \\
       \DIFdelbegin %DIFDELCMD < \affaddr{Dept. of ECE}%%%
\DIFdelend \DIFaddbegin \affaddr{Dept. of Computer Science}\DIFaddend \\
       \DIFdelbegin %DIFDELCMD < \affaddr{National University of Singapore}%%%
\DIFdelend \DIFaddbegin \affaddr{Indian Institute Of Technology Ropar}\DIFaddend \\
       \DIFdelbegin %DIFDELCMD < \email{elerdg@nus.edu.sg}
%DIFDELCMD < %%%
\DIFdelend \DIFaddbegin \email{2016csb1035@iitrpr.ac.in}
\DIFaddend \and 
\alignauthor \DIFdelbegin \DIFdel{Shuicheng Yan}\DIFdelend \DIFaddbegin \DIFadd{Mattela Nithish}\DIFaddend \\
       \DIFdelbegin %DIFDELCMD < \affaddr{Dept. of ECE}%%%
\DIFdelend \DIFaddbegin \affaddr{Dept. of Computer Science}\DIFaddend \\
       \DIFdelbegin %DIFDELCMD < \affaddr{National University of Singapore}%%%
\DIFdelend \DIFaddbegin \affaddr{Indian Institute Of Technology Ropar}\DIFaddend \\
        \DIFdelbegin %DIFDELCMD < \affaddr{\href{elerdg@nus.edu.sg}{elerdg@nus.edu.sg}}
%DIFDELCMD < %%%
\DIFdelend \DIFaddbegin \email{2016csb1042@iitrpr.ac.in}
\DIFaddend \alignauthor \DIFdelbegin \DIFdel{Wei Tsang Ooi}\DIFdelend \DIFaddbegin \DIFadd{Rishab}\DIFaddend \\
       \affaddr{Dept. of Computer Science}\\
       \DIFdelbegin %DIFDELCMD < \affaddr{National University of Singapore}%%%
\DIFdelend \DIFaddbegin \affaddr{Indian Institute Of Technology Ropar}\DIFaddend \\
       \DIFdelbegin %DIFDELCMD < \email{ooiwt@comp.nus.edu.sg}
%DIFDELCMD < %%%
\DIFdelend \DIFaddbegin \email{2016csb1035@iitrpr.ac.in}
\DIFaddend }
...
Understanding}{Video AnalysisVideo Analysis}
...
\DIFdelbegin \DIFdel{Mobile phones are becoming very popular,especially android phones with camera megapixels as huge as 16mp became very common now-a-days. }\DIFdelend Worldwide shipment of camera phones were estimated to reach
...
In this section, we first enumerate the design principles that we have followed in the development of MoViMash and then describe the framework. \DIFaddbegin \DIFadd{After an overview of MoViMash, }\DIFaddend we focus on individual components\DIFdelbegin \DIFdel{after an overview of MoViMash}\DIFdelend .
